...
RESULTS_DIR = "results"
PRODUCT = "FubuPersistence"
COPYRIGHT = 'Copyright 2012 FubuPersistence. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuPersistence.sln', :clrversion => CLR_TOOLS_VERSION
